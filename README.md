...
│
├── README.md
├── SentimentumAI_Sprint1.ipynb       # Notebook único: HU-01 a HU-02 (exploración, limpieza y normalización de texto)
│
├── Datos/
...
│
└── outputs/
    └── distribucion_clases.png       # Gráfica preliminar de distribución de clases
```
